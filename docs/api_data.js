define({ api: [
  ...
  {
    "type": "put",
    "url": "/users/:user/credit-requests/:id/approve",
    "title": "Approves creditRequest info in database",
    "name": "approveCreditRequest",
    "version": "2.0.1",
    "group": "creditRequest",
    "permission": "none",
    "description": "Updates creditRequest info in database.",
    "error": {
      "examples": [
        {
          "title": "    HTTP/1.1 400 Bad Request",
  ...
  {
    "type": "post",
    "url": "/users/:user/credit-requests",
    "title": "Creates a new creditRequest in database.",
    "name": "createCreditRequest",
    "version": "2.0.1",
    "group": "creditRequest",
    "permission": "none",
    "description": "Creates a new creditRequest in database.",
    "error": {
      "examples": [
        {
          "title": "    HTTP/1.1 400 Bad Request",
  ...
  },
  {
    ...
    "title": "Get creditRequest info in database",
    "name": "getCreditRequest",
    "version": "2.0.1",
    "group": "creditRequest",
    "permission": "none",
    "description": "Get creditRequest info in database.",
    "success": {
      "examples": [
        {
          "title": "    HTTP/1.1 200 Ok",
  ...
  },
  {
    ...
    "group": "creditRequest",
    "permission": "none",
    "description": "Removes creditRequest from database",
    "filename": "controllers/credit-request.js"
  },
  {
    "success": {
